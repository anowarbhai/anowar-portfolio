...
const services = [
  {
    ...
    description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas dignissimos atque, molestiae',
    href: ''
  },
  {
    num: '02',
          ...
          {services.map((service, index) => {
            return <div key={index} className="flex-1 flex flex-col justify-center gap-6 group">
              <div className="w-full flex justify-between items-center">
                <div className="text-5xl font-extrabold text-outline text-transparent group-hover:text-outline-hover transi duration-500">{service.num}</div>
